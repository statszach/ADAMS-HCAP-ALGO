...
if (user == "Emma") {
  if (Sys.info()["sysname"] == "Windows") {
    data_filepath <- "C:\\Users\\emmanich.HP\\P2AGING Dropbox\\Emma Nichols\\projects\\hcapalgorithm_adams\\data\\source\\"
    rds_filepath <- "C:\\Users\\emmanich.HP\\P2AGING Dropbox\\Emma Nichols\\projects\\hcapalgorithm_adams\\data\\derived\\"
    code_filepath <- "C:\\Users\\emmanich.HP\\code\\ADAMS-HCAP-ALGO\\"
    images_filepath <- "C:\\Users\\emmanich.HP\\P2AGING Dropbox\\Emma Nichols\\projects\\hcapalgorithm_adams\\plots\\"
  } else {
